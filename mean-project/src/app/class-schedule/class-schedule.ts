...
//         next: (data => { this.classSchedules = data }),
//         error: (err => console.error(err)),
//         complete: (() => console.log('Finished loading class schedules'))
//       });
//     }
...
//   const newSchedule = this.classForm.value;

//   this._myService.addClassSchedules(
//     (newSchedule.className ?? '').trim(),
//     (newSchedule.professor ?? '').trim(),
//     (newSchedule.day ?? '').trim(),
//     (newSchedule.time ?? '').trim()
//   ).subscribe({
//     next: (res) => {
//       console.log('Class schedule added:', res);
//       this.getClassSchedules(); // refresh list
...
//   this.classes[this.editIndex] = updatedClass;
...
//   this._myService.deleteStudent(studentId).subscribe(() => {
...
//     professor: (formValue.professor ?? '').trim(),
//     day:       (formValue.day ?? '').trim(),
//     time:      (formValue.time ?? '').trim()
//   };

//   if (this.editIndex !== null) {
//     // Update existing class in local array
//     this.classes[this.editIndex] = classData;
//     this.editIndex = null;
//   } else {
